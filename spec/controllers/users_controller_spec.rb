...
describe UsersController do
  ...
  describe "GET index" do
    it "assigns all users as @users" do
      user = User.make!(:role => 'normal')
      User.stub(:accessible_by) { [user].paginate }
      get :index
      assigns(:users).should == [user].paginate
    end
  end
  ...
  describe "PUT update" do
    ...
    describe "with invalid params" do
      ...
      it "not changes role if cannot assign role to user" do
        ...
        other_user.reload
        other_user.role.should eql('normal')
      end
    end
  end
